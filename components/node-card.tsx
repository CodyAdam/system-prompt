  ...
  return (
    ...
    >
      ...
      >
        ...
        {buttons}
        <Button variant="ghost" className="-m-1 size-8" disabled={isLoading} size={"icon"} onClick={handleRun}>
          {isLoading ? <RiLoader5Line className="size-5 animate-spin" /> : <RiPlayLine className="size-5" />}
        </Button>
        <Button variant="ghost" className="-m-1 size-8" size={"icon"} onClick={handleDelete}>
