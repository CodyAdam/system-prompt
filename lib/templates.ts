...
export const templates: Canvas[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        data: {
          ...
          loading: false,
          output:
            "TL;DR: System Prompt is a free, open-source, local (browser-based) tool that lets you visually build, save, and reuse complex AI workflows and templates by chaining different AI models and prompts, making your AI interactions more efficient and consistent.",
        },
        position: {
          x: -4.583680635039883,
          y: 368.5658160112734,
      ...
      },
      {
        ...
        data: {
          ...
          output:
            "TL;DR: System Prompt is a free, open-source, local (browser-based) tool that lets you visually build, save, and reuse complex AI workflows and templates by chaining different AI models and prompts, making your AI interactions more efficient and consistent.",
          text: "TL;DR: System Prompt is a free, open-source, local (browser-based) tool that lets you visually build, save, and reuse complex AI workflows and templates by chaining different AI models and prompts, making your AI interactions more efficient and consistent.",
        },
        position: {
          x: 1.6001159343593372,
          y: 693.5594135923411,
        },
        width: 491,
        height: 260,
      ...
      },
      {
        ...
        data: {
          text: "Hi Welcome to System Prompt!\n\nHere's how it works, you have 3 nodes:\n- Prompt: used as input for AI\n- AI: select a model and a system prompt \n- Markdown: show the output of an AI node\n\nLink nodes together and the output will be passed to the next one when pressing the ▶️ button.",
          loading: false,
        },
        position: {
          x: -921.5664061080294,
      ...
      },
      {
        ...
        position: {
          x: 1.0376806278530069,
          y: -130.31553708165086,
        },
        width: 200,
        height: 140,
        type: "annotation",
    ...
    updatedAt: "2025-07-03T08:13:44.753Z",
    createdAt: "2025-07-03T08:13:44.561Z",
  },
  {
